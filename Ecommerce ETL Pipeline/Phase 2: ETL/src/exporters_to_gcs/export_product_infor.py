...
# =====================================================================
# 7. HỖ TRỢ TÌM DANH SÁCH PRODUCT BỊ FAIL ĐỂ RETRY
# =====================================================================
def upload_to_gcs(bucket_name, destination_blob_name, local_file_path):
    """
    Upload 1 file local lên GCS.
    - bucket_name: tên bucket (vd: raw_product_infor)
    - destination_blob_name: tên file trên GCS (vd: product_infor.jsonl)
    - local_file_path: đường dẫn file local (vd: product_infor.jsonl)
    """
...
# =====================================================================
# 8. MAIN FLOW: CRAWL + RETRY FAIL + Upload GCS
# =====================================================================
async def main():
    ...
    result1 = await crawl_products(
        all_ids,
        "Project6/data/product_infor.jsonl",
        "Project6/data/log_infor.jsonl"
    )
    #upload_gcs
    if result1:
        upload_to_gcs("raw_product_infor", "product_infor.jsonl", "Project6/data/product_infor.jsonl")
    ...
    results2 = await crawl_products(
        fail_ids,
        "Project6/data/product_infor_retry.jsonl",
        "Project6/data/log_infor_retry.jsonl"
    )
    #upload_gcs
    if results2:
        upload_to_gcs("raw_product_infor", "product_infor_retry.jsonl", "Project6/data/product_infor_retry.jsonl")
